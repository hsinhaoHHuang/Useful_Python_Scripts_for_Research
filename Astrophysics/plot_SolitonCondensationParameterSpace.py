...
ax1.set_ylabel(r'$\rho$'+" (Msun/kpc$^3$)")
...
ax4.set_ylabel(r'$\rho$'+" (Msun/kpc$^3$)")
...
ax6.set_xscale("log")
ax6.set_yscale("log")
ax6.set_xlabel(r'$\rho$'+" (Msun/kpc$^3$)")
...
ax3.set_xscale("log")
ax3.set_yscale("log")
ax3.set_xlabel(r'$\rho$'+" (Msun/kpc$^3$)")
...
ax7.set_xscale("log")
ax7.set_yscale("log")
ax7.set_xlabel(r'$\rho$'+" (Msun/kpc$^3$)")
